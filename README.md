...
Текущая версия — **0.5.0-rc4**. Это release candidate: он ещё не проверен на
...
Пункт **POI: все категории** включает и выключает все маркеры достопримечательностей,
а пять строк ниже управляют их категориями независимо от collectibles. Значки collectibles — встроенные PNG с лёгкой тенью; найденные
